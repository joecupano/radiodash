...
function rxwinMSGhelp() {
	...
	rxDisplay [8] = "-"	  
  	rxDisplay [7] = "- LOG = Logging on/off (toggle) "
  	rxDisplay [6] = "- RCLR = Clear RX Window "
  	rxDisplay [5] = "- CALL = myCall Macro "
  	rxDisplay [4] = "- DEST = dstCall Macro"
	rxDisplay [3] = "- HEAD = Message Header Macro"
	rxDisplay [2] = "- MESG = Beacon Msg Macro"  
...
function rxwinMSGhelp111() {
	...
	rxDisplay [8] = "-"	  
  	...
  	rxDisplay [5] = "-  msgBCN blah blah    Changes MESG macro to hold blah blah"
  	rxDisplay [4] = "-"
